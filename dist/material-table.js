...
var MaterialTable = /*#__PURE__*/function (_React$Component) {
  ...
  function MaterialTable(_props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onHandleExport", function () {
      if (_this.props.options.exportCsv) {
        _this.props.options.exportCsv(_this.props.columns, _this.props.data);
      } else {
        _this.dataManager.handleCsvExport();
      }
    });
  ...
  (0, _createClass2["default"])(MaterialTable, [{
    ...
    value: function setDataManagerFields(props, isInit) {
      ...
      this.dataManager.changeDetailPanelType(props.options.detailPanelType); // ==== NOTE added these ===

      this.dataManager.setExportDelimeter(props.exportDelimiter);
      this.dataManager.setAllExportData(props.exportAllData);
      this.dataManager.setExportFileName(props.exportFileName || props.title || "data");
    }
  }, {
